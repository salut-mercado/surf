...
const DraggableWindow = ({ open, onClose, children }: DraggableWindowProps) => {
  ...
  const onResizeMouseMove = (e: MouseEvent) => {
    ...
    if (resizing.current === "right" || resizing.current === "corner") {
      newWidth = Math.max(MIN_WIDTH, start.width + (e.clientX - start.x));
    }
    if (resizing.current === "bottom" || resizing.current === "corner") {
      newHeight = Math.max(MIN_HEIGHT, start.height + (e.clientY - start.y));
    }
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        style={{ position: "absolute", top: 8, right: 8, zIndex: 21 }}
      >
        ×
      </button>
      ...
      <div
        ...
        style={{
          ...
          zIndex: 1001,
          background:
            resizing.current === "right" ? "rgba(0,0,0,0.07)" : "transparent",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          zIndex: 1001,
          background:
            resizing.current === "bottom" ? "rgba(0,0,0,0.07)" : "transparent",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          zIndex: 1002,
          background:
            resizing.current === "corner" ? "rgba(0,0,0,0.10)" : "transparent",
          display: "flex",
          alignItems: "flex-end",
